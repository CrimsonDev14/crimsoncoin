crimson version 0.5.4 is now available for download at:
http://sourceforge.net/projects/crimson/files/crimson/crimson-0.5.4/
...
http://gitorious.org/crimson/crimsond-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix crimson-Qt notifications under Growl 1.3.
Increase required age of crimson-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxcrimson properly when installing crimson-Qt over it. (Windows)
