crimson Core version 0.9.4 is now available from:

  https://crimson.org/bin/0.9.4/
...
this update is incompatible with the crimson system and could lead to consensus
forks.

crimson Core released binaries from https://crimson.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~crimson/+archive/ubuntu/crimson
- A third-party or self-compiled crimson Core

upgrade to crimson Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
