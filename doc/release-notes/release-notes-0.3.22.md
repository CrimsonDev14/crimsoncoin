Download URL: https://sourceforge.net/projects/crimson/files/crimson/crimson-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 DGB fee schedule (users still pay 0.01 DGB per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #crimson00 - #crimson99
