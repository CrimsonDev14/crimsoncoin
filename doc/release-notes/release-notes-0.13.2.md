crimson Core version 0.13.2 is now available from:

  <https://crimson.org/bin/crimson-core-0.13.2/>
...
- #8908 `4a974b2` Update crimson-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow crimson-tx to create v2 transactions (dgbdrak)
