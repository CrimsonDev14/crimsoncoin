crimson Core version 0.10.4 is now available from:

  <https://crimson.org/bin/crimson-core-0.10.4/>
...
- #6953 `43c2789` Split crimson-tx into its own package
- #6953 `dfe0d4d` Include crimson-tx binary on Debian/Ubuntu
