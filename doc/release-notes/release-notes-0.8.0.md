crimson-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/crimson/files/crimson/crimson-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the crimson
...
New/changed settings (command-line or crimson.conf file)
--------------------------------------------------------
