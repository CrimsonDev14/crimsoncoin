...
This document provides guidelines for internationalization of the crimson Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `crimson_en.ts` remains unchanged.
