...
# Copyright 2016 The crimson Core developers
...
help_text="""Test framework for crimson utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/crimson-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "crimson-util-test.json", buildenv)
