...
#ifndef crimson_QT_crimsonUNITS_H
#define crimson_QT_crimsonUNITS_H
...
/** crimson unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class crimsonUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit crimsonUnits(QObject *parent);

    /** crimson units.
      @note Source: https://en.crimson.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CRM,
...
typedef crimsonUnits::Unit crimsonUnit;

#endif // crimson_QT_crimsonUNITS_H
