...
public:
    CMainParams() {
        ...
        /** Current crimson 2017 Difficulty Adjustment Code & Block Target. See explanation here: 
        https://github.com/crimson/crimson-old/pull/36 
        https://github.com/crimson/crimson-old/pull/15
        ...
        **/
        ...
        // crimson Hard Fork Block Heights
        ...
        vSeeds.push_back(CDNSSeedData("crimson.co", "seed.crimson.co"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("crimsonwiki.com", "testnet-seed.crimsonwiki.com"));
