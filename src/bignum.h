...
// Copyright (c) 2009-2013 The crimson developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef crimson_BIGNUM_H
#define crimson_BIGNUM_H
...
public:
    ...
    //
    // crimson only uses this "compact" format for encoding difficulty
