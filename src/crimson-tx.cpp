...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s crimson-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  crimson-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded crimson transaction") + "\n" +
              "  crimson-tx [options] -create [commands]   " + _("Create hex-encoded crimson transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CcrimsonAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CcrimsonAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded crimson transaction
