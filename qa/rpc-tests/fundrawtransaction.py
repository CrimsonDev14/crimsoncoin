...
class RawTransactionsTest(crimsonTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid crimson address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid crimson address" in e.error['message'])
