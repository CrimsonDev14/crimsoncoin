...
unlocked to sign the crimson-Qt.app bundle.
...
allowing somebody to distribute a crimson-Qt.app or crimson-qt-setup.exe with a valid
...
that the crimson-qt.exe file inside the installer had not been tampered with.
